...
class MultipleChoiceController {
    ...
    async createMultipleChoice(req, res) {
        try {
    ...
    async getAllMultipleChoices(req, res) {
        try {
            const filters = {};
    ...
    async getMultipleChoiceById(req, res) {
        try {
    ...
    async updateMultipleChoice(req, res) {
        try {
    ...
    async deleteMultipleChoice(req, res) {
        try {
    ...
    async searchMultipleChoices(req, res) {
        try {
            const { q } = req.query;
            if (!q) {
